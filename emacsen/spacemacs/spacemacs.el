...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     (ivy
      :variables ivy-enable-advanced-buffer-information t)
     ...
     (python
      ...
      python-lsp-git-root
      (expand-file-name
       "~/Dropbox/repos/github/microsoft/python-language-server")
     ...
     (version-control
      :variables
      ;; 'diff-hl, 'git-gutter or 'git-gutter+
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  (setq spacemacs-private-directory
        (expand-file-name
         "~/Dropbox/repos/github/five-dots/dotfiles/emacsen/spacemacs/private/"))

  ;; Load private consts/vars
...
before packages are loaded."
  ...
  (load (expand-file-name
  		 "~/Dropbox/repos/github/five-dots/dotfiles/emacsen/spacemacs/config.el")))
