   ...
   dotspacemacs-default-font `("Consolas NF"
                               :size ,(let ((name (system-name))
                                        ...
                                        (cond
                                         ...
                                         ((and (equal name "x1") (= num-disp 1)) 16.3) ; 14.3
...
before packages are loaded."
  ...
  (org-babel-load-file
   (expand-file-name "~/Dropbox/repos/github/five-dots/dotfiles/spacemacs.d/spacemacs_init.org"))
  )
